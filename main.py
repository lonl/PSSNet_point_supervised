...
def main():
    ...
    # Ablation checkpoint file
    # path_model = "Ablation/oilpalm_only_point/best_model_{}.pth".format(name)
    # path_opt = "Ablation/oilpalm_only_point/opt_{}.pth".format(name)
    # path_best_model = "Ablation/oilpalm_only_point/best_model_save_{}.pth".format(name)
    # path_history = "Ablation/oilpalm_only_point/history_{}.json".format(name)
